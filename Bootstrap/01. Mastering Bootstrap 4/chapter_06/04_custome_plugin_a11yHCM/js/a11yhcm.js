+ function ($) {      
  'use strict';       // A11YHCM CLASS DEFINITION
       // ======================
        
  ...
  A11yHCM.prototype.toggle = function (e) {      
      ...
      if ($this.attr('a11yhcm-id')) $this.styleSheetID = $this.attr('a11yhcm-id')  
      else $this.styleSheetID = A11yHCM.DEFAULTS.styleSheetID   
...
// A11YHCM DATA-API
// ==============
$(document).on('click.bs.allyhcm.data-api', '[data-a11yhcm]', A11yHCM.prototype.toggle)
