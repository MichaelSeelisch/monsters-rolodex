...
var render = function render() {
    ...
    posts.forEach(function (post, index) {
        ...
        item.addEventListener('click', function () {
            return store.dispatch((0, _actions.editPost)(index, post.text + '!'));
        });

        var text = document.createTextNode(post.user + ' - ' + post.text);
        item.appendChild(text);
        root.appendChild(item);
    });
};

var stopRender = store.subscribe(render);

store.dispatch((0, _actions.createPost)('dan', 'hello world'));
store.dispatch((0, _actions.createPost)('des', 'second post'));
