...
var _ConnectedPostList = __webpack_require__(33);
...
var ConnectedPostList = function (_Component) {
    _inherits(ConnectedPostList, _Component);

    function ConnectedPostList(props) {
        _classCallCheck(this, ConnectedPostList);

        var _this = _possibleConstructorReturn(this, (ConnectedPostList.__proto__ || Object.getPrototypeOf(ConnectedPostList)).call(this, props));

        _this.state = props.store.getState();
        return _this;
    }

    _createClass(ConnectedPostList, [{
        ...
        value: function componentDidMount() {
            ...
            this.unsubscribe = store.subscribe(function () {
                return _this2.setState(_extends({}, store.getState()));
            });
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement(_PostList2.default, this.state);
        }
    }]);

    return ConnectedPostList;
}(_react.Component);
