...
export class WorkoutRunner {
  ...
  restExercises: ExercisePlan;
  workoutTimeRemainig: number;
  ...
  constructor() {
    ...
    this.restExercises = new ExercisePlan(
    ...
    workout.exercises.push(
      new ExercisePlan(
        new Exercise(
          'jumpingJacks',
          'Jumping Jacks',
          'A jumping jack or stay jump, also called side-straddle hop is a physical jumping exercise.',
          'JumpingJacks.png',
          'jumpingjacks.wav',
          `Assume a erect position, with feet together and arms at ypur side...`,
          ['dmYwZH_BND0', 'BABOdJ-2Z60', 'c4DAnQ6DtF8']),
          30
        )
      );
