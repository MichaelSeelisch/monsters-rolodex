export default class StudentAttendanceTable extends HTMLElement {
    ...
    getStudentList() {
        // lets use fetch api https://developer.mozilla.org/en-US/docs/Web
        ...
        fetch('./student.json')
            ...
            .catch(e => {
                ...
                // lets set the error message for the user
                this.innerText = this.getErrorText();

                // lets print out the error message for the devs
                console.log(e);
            });
    }

    generateTable(names) {
        // lets loop through names with the help of map
