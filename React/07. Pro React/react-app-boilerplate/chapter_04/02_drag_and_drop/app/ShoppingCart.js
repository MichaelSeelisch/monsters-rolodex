...
//
//  - connect: An instance of DropTargetConnector. You use it to assign the drop target role to a DOM node.
//  - monitor: An instance of DropTargetMonitor. You use it to connect state from the React DnD to props.
