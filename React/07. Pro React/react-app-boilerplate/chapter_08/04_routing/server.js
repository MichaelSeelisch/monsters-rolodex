...
/*
 * Helper function: Loop trough all components in the renderProps object
 * and returns an new object with the desired key
 */
...
let renderRoute = (response, renderProps) => {
  ...
  if (routeProps.requestInitialData) {
    ...
    routeProps.requestInitialData().then((data) => {
      // Overwrite the react-router create element function and pass the pre-fetched data as initialData props
      let handleCreateElement = (Component, props) => (
        <ContactsApp initialData={data} {...props} />
      );
