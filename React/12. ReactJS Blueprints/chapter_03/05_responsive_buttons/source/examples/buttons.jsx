  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* 
          The main difference between ButtonGroup and ButtonToolbar is that ButtonToolbar will preserve 
          the spacing between multiple inline buttons or button groups, whereas ButtonGroup will not.
        */}
        <ButtonToolbar>
