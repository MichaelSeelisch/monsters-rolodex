...
import StaticMapView from './views/static-map';
import DynamicMapView from './views/interactive-map';
...
const App = React.createClass({
  ...
  fetchFunc(res) {
    ...
    if (this.state.coords.latitude !== coords.latitude && this.state.coords.longitude !== coords.longitude) {
      this.setState({
        lat: coords.latitude,
  ...
  debugPageLoadDelay() {
    return "timing" in performance ?
      <div>Page load delay experienced from page load start to navigation start:{" "}
